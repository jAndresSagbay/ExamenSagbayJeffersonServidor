...
a persistence unit "ExamenSagbayJeffersonServidor1PersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "ExamenSagbayJeffersonServidor1\pom.xml":
...
artifact ("ExamenSagbayJeffersonServidor1.war") is already built. You can build
